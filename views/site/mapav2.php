        ...
        <div class="modal-dialog">
            <div class="modal-content">
                                    ...
                                    <div class="info-block block-info clearfix">
                                        <div data-toggle="buttons" class="btn-group bizmoduleselect">
                                            <label class="btn btn-default marcar">
                                                <div class="bizcontent">
                                                    <input type="checkbox" class="marcar" name="crs[]" id="crs" autocomplete="off" value="<?= $value->id; ?>">
                                                    <small><p style="max-height:30px;white-space: pre-wrap;word-wrap: break-word;"><?= $value->nome; ?></small>
                                                </div>
                                            </label>
                                        </div>
                                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="initMapa" data-on-done="simpleDone" data-dismiss="modal" data-form-id="formReg" role="dialog" class="btn btn_mFiltros btn-primary">Salvar</button>
                </div>
            </div>
        </div>
    </div>
...
?>
        <!-- Maps API Javascript -->
<script type="text/javascript" src="http://maps.googleapis.com/maps/api/js?v=3&key=AIzaSyBC52jiaTp1RQFL6c1reMZdEPtQde9ZSC0&sensor=TRUE"></script>